...
const HeroSection = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0e0c15] via-[#0e0c15] to-[#0f3460] bg-fixed">
      ...
      <section
        id="home"
        className="flex w-full flex-col md:flex-row items-center pt-10 mt-0  justify-between p-6 md:p-10 min-h-screen space-y-6 md:space-y-0 "
      >
        {/* Left: Hero Content */}
        <div className="flex flex-col px-6 w-full md:w-1/2 space-y-6">
          ...
          <button className="gradient-button w-fit">Explore Plans</button>

          {/* Statistics */}
          <div className="flex flex-wrap md:flex-nowrap md:space-x-6 mt-6 justify-center gap-y-4">
            {[
        ...
        {/* Right: Image Grid */}
        <div className="flex flex-col w-full md:w-1/2 items-center md:items-end gap-4">
          {/* Image Grid */}
