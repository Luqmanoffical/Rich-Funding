...
const properties = [
    {
      ...
      description: 
       ` 73,800+ square feet, 11.28-acre site, zoned for commercial/retail uses.
    ...
    {
      title: 'Greenfield Office Complex',
      investment: '12,000,000',
      image: propertyImage,
      location: 'Downtown Los Angeles, California',
      description: 
       ` 150,000+ square feet, 5-acre site, prime office space location.
    ...
    },
    {
      ...
      description: 
        `45,000+ square feet, 10-acre site, zoned for residential use.
    ...
    },
    {
      ...
      description: 
       ` 120,000+ square feet, 15-acre site, mixed-use commercial space.
    ...
    },
    {
      ...
      description: 
        `50,000+ square feet, 3-acre waterfront site, zoned for luxury condos.
    ...
    },
    {
      ...
      description: 
       ` 200,000+ square feet, 10-acre site, commercial/office redevelopment.
    ...
    },
    {
      ...
      description: 
       ` 100,000+ square feet, 20-acre resort development.
    ...
    },
    {
      ...
      description: 
        `130,000+ square feet, 8-acre site, industrial park development.
  ...
  return (
    <div  id='investing' className="flex flex-col items-center py-16 px-6 lg:px-20">
      ...
      <div className="flex w-full">
        ...
        <div className="w-1/4 pr-6 sticky top-4 h-full">
          <h3 className="text-xl font-bold text-gray-200 mb-6">Filter by Investment</h3>
          <button
        ...
        {/* Property Cards */}
        <div className="w-3/4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
          {filteredProperties.length > 0 ? (
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="mt-6 flex items-center justify-between">
                    ...
                    <a
                      href={property.pdf}
                      className="text-sm font-semibold text-[#aa3ea5] hover:underline flex items-center"
                    >
                      Download PDF
                      <FaFileDownload className="ml-2 text-lg" />
                    </a>
                  </div>
                </div>
              </div>
            ...
            <p className="text-center text-gray-300 mt-10 col-span-full">None Posted Yet<br />Please Contact Me To Post Your Property</p>
          )}
        </div>
      </div>
    </div>
